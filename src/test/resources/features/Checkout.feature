Feature: Checkout
  ...
  Scenario: Checkout
    ...
    When I use the valid first name "Test", last name "Tester", company name "Test", street address "404 Test Street", address line two "Test", city "Test", county "Test", postcode "EH21DJ", phone "07777777777" to go through checkout
